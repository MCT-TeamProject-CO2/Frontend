const showChart = (dataType, data) => {
    let historyHTML = document.querySelector(".js-graph");
    historyHTML.innerHTML = `<canvas class="c-chart js-graph-canvas" data-type="${dataType}"></canvas>`;
    ...
    if (data.hasOwnProperty(dataType)) {
        chart = document.querySelector(".js-graph-canvas").getContext("2d");
